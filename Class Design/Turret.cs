...
namespace FighterProgram
{
        ...
        // Pre-condition: In the constructor, `row`, `column`, `strength`, `attackRange`, `reviveBound`, and `artilleryProvider` parameters must be non-negative.
        // Post-condition: Set all the properties values to their parameter equivalents.
        public Turret(int row, int column, int strength, int attackRange, int reviveBound, int[] artilleryProvider)
