...
namespace FighterProgram
{
    public class Infantry : Fighter
    {
        ...
        // Pre-condition: In the constructor, `row`, `column`, `strength`, and `attackRange` parameters must be non-negative.
        // Post-condition: Set all the properties values to their parameter equivalents.
        public Infantry(int row, int column, int strength, int attackRange, int[] artilleryProvider)
...
// - Once Infantry has moved, they are unable to move back to its last direction
